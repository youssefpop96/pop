...
class _NoteDetailScreenState extends State<NoteDetailScreen> {
  ...
  void _initQuillController(dynamic content) {
    if (content != null) {
      try {
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      currentNote.title,
                      style: AppTextStyles.headlineLg.copyWith(fontSize: 32, height: 1.2),
                    ),
                  ),
                  const SizedBox(height: 32),
                  Center(
  ...
  Widget _buildDateHeader(DateTime date) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          const Icon(Icons.calendar_month_rounded, size: 16, color: AppColors.kPrimary),
      ...
      doc.addPage(
        pw.MultiPage(
          ...
          build: (context) => [
            ...
            pw.Divider(),
            pw.Paragraph(text: plainText, style: const pw.TextStyle(fontSize: 14)),
          ],
        ),
      );
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: const Icon(Icons.add_a_photo_rounded, color: AppColors.kPrimary, size: 32),
                ),
              ),
            ],
          ),
      ...
      children: [
        ...
        Wrap(
          ...
          children: tags.map((tag) => TagChip(
            ...
            onTap: () {}, // إضافة onTap فارغ ليتوافق مع الـ Required
          )).toList(),
        ),
      ],
    );
