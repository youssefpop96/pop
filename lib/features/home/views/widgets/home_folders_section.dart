...
class HomeFoldersSection extends StatelessWidget {
  ...
  const HomeFoldersSection({super.key, required this.folders});

  @override
  Widget build(BuildContext context) {
    if (folders.isEmpty) return const SizedBox();

    // Expanded pool of colors and icons for dynamic mapping
    final List<List<Color>> gradientPool = [
      ...
      [const Color(0xFFF44336), const Color(0xFFFF8A80)], // Red Gradient
      [const Color(0xFFCDDC39), const Color(0xFFE6EE9C)], // Lime Gradient
    ];
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          // Map icon index (preferring iconName handle if available)
          int iconIndex = 0;
